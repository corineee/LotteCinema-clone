...
<div class="list_up">
	<ul>
		<li class="question_list"><a href="${contextPath }/board/question">자주하는 질문</a></li>
	...
	<div class="content" >
		<div id="Q1" class="question">
			<button>Q&A 회원가입은 어떻게 하는 건가요? </button>
			<div class="answer">
				<span>
				홈페이지 우측 상단의 [회원가입] 버튼을 누르거나 로그인 버튼 클릭 시 노출되는 [회원가입] 버튼을 클릭해 회원에 가입할 수 있습니다.
				</span>
			</div>
		</div>
		
		<div id="Q2" class="question">
			<button>Q&A 회원정보 수정은 어떻게 할 수 있나요?</button>
			<div class="answer">
				<span>
				 [마이시네마] → [나의정보관리] → [회원정보 변경]에서 가능합니다.
				</span>
		...
		<div id="Q3" class="question">
			<button>Q&A 비회원도 영화 예매가 가능하나요?</button>
			<div class="answer">
				
				<span>
				비회원 약관 동의 후에 기초 개인정보 (성명+생년월일+휴대폰번호+비밀번호 4자리) 설정 후 예매 가능합니다.<br>
				비회원 로그인 시 예매 및 예매확인/취소 메뉴만 이용 가능하며<br>
				관람권, 할인권을 포함한 기타 결제/할인 수단을 사용할 수 없습니다.<br>
				</span>
		...
		<div id="Q4" class="question">
			<button>Q&A 영화 예매 취소는 어떻게 진행되나요?</button>
			<div class="answer">
				...
				<span>
				 ■ 티켓예매 (결제 방법)<br>
					...
					ㆍ 영화관 현장 예매는   영화 시작시간까지 예매 가능합니다.<br><br>

				 ■ 티켓취소<br>
					ㆍ 홈페이지 취소는 영화 시작시간 20분 전까지 취소 가능합니다.<br>
					ㆍ 모바일 앱/웹 취소는 영화 시작시간 20분 전까지 취소 가능합니다.<br>
					ㆍ 영화관 현장 취소는 영화 시작시간 직전까지 취소 가능합니다.<br><br>

				※ 현장에서 티켓으로 출력을 진행한 경우 온라인 취소가 불가능하며,<br>
		...
		<div id="Q5" class="question">
			<button>Q&A 회원 탈퇴는 어떻게 하나요?</button>
			<div class="answer">
				<span>
				회원 탈퇴를 원하실 경우, 홈페이지 [마이시네마] → [나의 정보관리] → [회원 탈퇴] 버튼을 클릭하여 회원 탈퇴가 가능합니다.
				</span>
			</div>
		</div>
	</div>
